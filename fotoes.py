...
def resize_foto(foto: Image, new_size: tuple) -> Image:
    ...
    return foto.resize(new_size, Image.ANTIALIAS)
...
def shuffle_foto(img: Image, kre8dict: dict) -> Image:
    ...
    shuf_img_pos_list = []
    num_of_tiles = "4x4"
    if "Shuffle Size" in kre8dict["Masterpiece"]:
        num_of_tiles = kre8dict["Masterpiece"]["Shuffle Size"]
    w, h = img.size
...
def hsb_filter_foto(img: Image, kre8dict: dict) -> Image:
    ...
    hsb_list = kre8dict["Masterpiece"]["Foto"]["HSB"]
    h, s, b = hsb_im.split()
...
def rgb_filter_foto(img: Image, kre8dict: dict) -> Image:
    ...
    rgb_list = kre8dict["Masterpiece"]["Foto"]["RGB"]
    r, g, b = rgb_im.split()
