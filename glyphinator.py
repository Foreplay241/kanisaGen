...
def ring_bity(img: Image, color_list: list) -> Image:
    ...
    w, h = img.size
    for i in range(96):
        draw.ellipse(((i * 1)-32, (i * 1)-32, (w+32) - (i * 1), (h+32) - (i * 1)), outline=random.choice(color_list), width=3)
    return img
...
def scales_bity(img: Image, color_list: list) -> Image:
    ...
    w, h = img.size
    for i in range(96):
        draw.ellipse((32-(i * 1), 32-(i * 1), (w+32) - (i * 1), (h+32) - (i * 1)), outline=random.choice(color_list), width=3)
        draw.ellipse(((i * 1), 32-(i * 1), (w) - (i * 1), (h+32) - (i * 1)), outline=random.choice(color_list), width=3)
        draw.ellipse((32-(i * 1), (i * 1), (w+32) - (i * 1), (h) - (i * 1)), outline=random.choice(color_list), width=3)
    return img
